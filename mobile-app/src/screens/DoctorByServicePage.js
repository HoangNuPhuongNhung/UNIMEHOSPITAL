...
const DoctorByServicePage = ({ route, navigation }) => {
    ...
    useEffect(() => {
        const fetchDoctors = async (serviceId) => {
            try {
                const response = await axios.get(`https://api.unime.site/UNIME/doctorservice/get/doctorList/${serviceId}`);
        ...
        fetchDoctors(service.serviceId);
    }, [service.serviceId]);
                    ...
                    <View key={doctor.doctorId} style={styles.card}>
                        ...
                        <View style={styles.infoContainer}>
                            ...
                            <View style={styles.buttonContainer}>
                                <TouchableOpacity
                                    style={styles.button}
                                    onPress={() => navigation.navigate('DoctorDetailPage', { doctor, service })}
                                >
                                    <Text style={styles.buttonText}>Xem chi tiết</Text>
                                </TouchableOpacity>
                                <TouchableOpacity
                                    style={styles.button}
                                    onPress={() => navigation.navigate('book doctor', { doctor, service })}
                                >
...
export default DoctorByServicePage;